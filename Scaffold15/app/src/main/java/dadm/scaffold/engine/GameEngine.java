...
public class GameEngine {
    ...
    public void gameEngineShowResult(boolean isVictory){
        ScaffoldActivity act = (ScaffoldActivity) mainActivity;
        act.showResult(isVictory);
    }

    public void gameEngineUpdatePoints(int points){
        ScaffoldActivity act = (ScaffoldActivity) mainActivity;
        act.p = points;
        act.updatePoints();
    }

    public void gameEngineUpdateHealth(int health){
        ScaffoldActivity act = (ScaffoldActivity) mainActivity;
        act.h = health;
        act.updateHealth();
    }
