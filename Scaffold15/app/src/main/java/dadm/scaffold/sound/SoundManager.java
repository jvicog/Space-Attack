...
public final class SoundManager {
	...
	private void loadSounds() {
		...
		loadEventSound(context, GameEvent.GetPoints, "Points.wav");
		loadEventSound(context, GameEvent.Reload, "Reload.wav");
	}
	...
	private void loadMusic() {
		try {
			...
			AssetFileDescriptor afd = context.getAssets().openFd("sfx/Music.mp3");
